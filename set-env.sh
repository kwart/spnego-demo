...
export BROWSER="google-chrome --auth-server-whitelist=$BIND_ADDRESS --auth-negotiate-delegate-whitelist=$BIND_ADDRESS --user-data-dir=$SPNEGO_TEST_DIR/chrome-profile"
